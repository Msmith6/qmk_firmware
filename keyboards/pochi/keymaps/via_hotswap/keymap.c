...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
        ...
        KC_LSFT,    KC_Z,      KC_X,       KC_C,       KC_V,       KC_B,      KC_N,      KC_M,    KC_COMM,   KC_DOT,               RSFT_T(KC_SLASH),
        KC_LALT,    KC_LCTL,   KC_LGUI,    KC_LGUI,    KC_SPC,     KC_SPC,    KC_SPC,    KC_SPC,  KC_RGUI,   MO(1),                MO(2)
    ),
    [1] = LAYOUT_all(
        KC_ESC,     KC_1,         KC_2,          KC_3,          KC_4,       KC_5,       KC_6,       KC_7,      KC_8,       KC_9,       KC_0,      KC_EXCLAIM,
