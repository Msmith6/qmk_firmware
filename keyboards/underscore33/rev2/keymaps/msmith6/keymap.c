...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT_33_big_space( \
  ...
  //|------------+-------------+------+------+------+------+------+--------+-------+----------------|
                                        KC_LGUI, KC_SPC, KC_PSCR
  ),

  [_LOWER] = LAYOUT_33_big_space( \
  //,----------------------------------------------------------------------------------------------.
  ...
  //|-----+--------+--------+--------+--------|--------+--------+--------+--------+--------|
     KC_F1,   KC_F2,   KC_F3,   KC_F4, KC_RALT, XXXXXXX,DEL_LINE, XXXXXXX, XXXXXXX,  MOUSE,\
  //|-----+--------+--------+--------+--------+--------+--------+--------+--------+--------|
                                  KC_LGUI, KC_SPC, KC_PSCR
  ),

  [_MOUSE] = LAYOUT_33_big_space( \
  //,------------------------------------------------------------------------------------------.
  ...
  //|-------+--------+--------+--------+---------|--------+--------+--------+--------+--------|
     KC_LCTL, KC_BTN5, XXXXXXX, KC_BTN4,  KC_BTN3, QWERTY, XXXXXXX,  XXXXXXX, XXXXXXX,   MOUSE,\
  //|-------+--------+--------+--------+---------+--------+--------+--------+--------+--------|
                                      KC_LGUI, KC_BTN1, KC_PSCR
  )
