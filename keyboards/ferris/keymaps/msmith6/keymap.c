...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-----+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------|
     KC_F1,   KC_F2,   KC_F3,   KC_F4, XXXXXXX,                      XXXXXXX,DEL_LINE, XXXXXXX, XXXXXXX,  MOUSE,\
  //|-----+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------|
                                          MISC, XXXXXXX,    KC_RALT, KC_RCTL \
                                  //`------------------'  `-----------------'
  ),
  ...
  //|-------+--------+--------+--------+---------|                    |--------+--------+--------+------------+-------------|
     KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R,  XXXXXXX,                      XXXXXXX, KC_MS_L, KC_MS_D,     KC_MS_U,      KC_MS_R,\
  //|-------+--------+--------+--------+---------|                    |--------+--------+--------+------------+-------------|
     KC_LCTL, KC_BTN5, XXXXXXX, KC_BTN4,  XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX,        MOUSE,\
  //|-------+--------+--------+--------+---------+--------|  |--------+--------+--------+--------+------------+-------------|
                                          KC_BTN3, KC_BTN1,    XXXXXXX, QWERTY \
                                     //`------------------'  `----------------'
